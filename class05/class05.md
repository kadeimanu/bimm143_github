...
There are lot’s of ways to make figures in R. These include so-caled
...
> end up re-installing packages many times - which is not what we want!

Every time you want to use on of these “add-on” packages we need to load
...
Version 2 that is colored by `State` so we can see the “up” and “down”
